...
void testBug(void)
{
#if !defined(__SDCC_mcs51) && !defined(__SDCC_ds390) && !defined(__SDCC_hc08) && !defined(__SDCC_s08) && !defined(__SDCC_pdk14) && !defined(__SDCC_pdk14) && !defined(__SDCC_pdk15) && !defined(__SDCC_m6502) && !defined(__SDCC_m65c02) /* mcs51, hc08, s08 and pdk14 have restrictions on function pointers wrt. reentrancy */
