/*------------------------------------------------------------------------
  ...
  SDCCralloc.c - source file for register allocation. 68M6502 specific
...
reg_info regsm6502[] =
{
  ...
  {REG_GPR, H_IDX,   "h",  M6502MASK_H,  NULL, 0, 1},
  {REG_PTR, HX_IDX,  "hx", M6502MASK_HX, NULL, 0, 1},
...
reg_info *m6502_reg_h;
reg_info *m6502_reg_hx;
  ...
  switch (reg->rIdx)
    {
      ...
      case H_IDX:
        ...
        break;
      case HX_IDX:
        m6502_reg_h->aop = NULL;
        m6502_reg_h->isFree = 0;
...
m6502_oldralloc (ebbIndex * ebbi)
{
  ...
  m6502_reg_h = m6502_regWithIdx(H_IDX);
  m6502_reg_hx = m6502_regWithIdx(HX_IDX);
